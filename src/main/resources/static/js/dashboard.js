...
var dashboard = (function (dashboard, $) {
    ...
    function totalChartDraw(result){
        ...
        for(var i=0;i<haughUnitList.length;i++){
            ...
            if(sampleOrderV > 11 && sampleOrderV != 18){
                huDataArrNw.push([yearV+"-"+monthV+"-"+dayV+" "+hourV+":"+minuteV+":"+secondV,levelV])
            }else{
                huDataArr.push([yearV+"-"+monthV+"-"+dayV+" "+hourV+":"+minuteV+":"+secondV,levelV])
            }
